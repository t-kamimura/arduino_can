...
unsigned int upos; // 16 bit
unsigned int uvel; // 12 bit
unsigned int ukp;  // 12 bit (defined as positive value only)
unsigned int ukd;  // 12 bit (defined as positive value only)
unsigned int uff;  // 12 bit
